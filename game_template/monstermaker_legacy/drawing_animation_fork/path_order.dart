...
class PathOrder {
  ...
  PathOrder.byLength({reverse = false}) : _comparator = _byLength(reverse: reverse);
  ...
  PathOrder.byPosition({required AxisDirection direction}) : _comparator = _byPosition(direction: direction);
