...
class StripedStrokeBrushSettings extends BrushSettings {
  ...
  StripedStrokeBrushSettings.fromJson(Map<String, dynamic> json)
    ...
    secondColor = Color(json["secondColor"]);
    width = json["width"];
    minStripeLength = json["minStripeLength"];
...
class WiggleBrushSettings extends BrushSettings {
  ...
  WiggleBrushSettings.fromJson(Map<String, dynamic> json)
    ...
    color = Color(json["color"]);
    secondColor =
        json["secondColor"] != null ? Color(json["secondColor"]) : null;
    minDiameter = json["minDiameter"];
    maxDiameter = json["maxDiameter"];
    filled = json["filled"];
  }
}
...
class BeadsBrushSettings extends BrushSettings {
  ...
  BeadsBrushSettings.fromJson(Map<String, dynamic> json)
    ...
    isRainbowColored = json["isRainbowColored"];
    minCircleDiameter = json["minCircleDiameter"];
    maxCircleDiameter = json["maxCircleDiameter"];
...
class StarryNightBrushSettings extends BrushSettings {
  ...
  StarryNightBrushSettings.fromJson(Map<String, dynamic> json)
    ...
    grainLength = json["grainLength"];
    grainThickness = json["grainThickness"];
    strokeWidth = json["width"];
    sprawl = json["sprawl"];
    lerps = json["lerps"];
  }
...
class TriangleBrushSettings extends BrushSettings {
  ...
  TriangleBrushSettings.fromJson(Map<String, dynamic> json)
    ...
    secondColor =
        json["secondColor"] != null ? Color(json["secondColor"]) : null;
    strokeWidth = json["strokeWidth"];
    maxBaseWidth = json["maxBaseWidth"];
    minBaseWidth = json["minBaseWidth"];
